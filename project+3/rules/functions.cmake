...
function( generate_kbuild arg1 arg2 arg3 arg4)
    set( moduleName ${arg1} )
    ...
    file( WRITE  "${outputDir}/Kbuild" "obj-m := ${moduleName}.o\n" )
...
######################################################################
#  generate the symbolic link from src dir to ouput dir
######################################################################

function( generate_symbolic_links arg1 arg2)
    set( srcFileList ${arg1} )
    set( dstDir ${arg2} )    
    
    foreach(srcFile ${srcFileList})
        get_filename_component( fileName ${srcFile} NAME )

        if ( NOT EXISTS "${dstDir}/${fileName}" )
            execute_process( COMMAND ln -s ${srcFile} "${dstDir}/${fileName}" )
        endif()
    endforeach()
